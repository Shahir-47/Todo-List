...
const displayTodoItem = (item) => {
    ...
    function updateTime() {
        ...
        if (dueTime == '') {
            ...
            } else if ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(relDueDate, (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(today, 1))) {
                distanceToDueDate = 'Tomorrow';
            } else  {
                // Calculate the time difference between the current date/time and the task due date
                const distanceInDays = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(relDueDate, today);
                if (distanceInDays < 0) {
            ...
            // Calculate the time difference between the current date/time and the task due date
            distanceToDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(taskDueDate, { addSuffix: true });
        }    
        ...
        if (itemSync.done.flag == false) {
            ...
            distanceToDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date(itemSync.done.timestamp), { addSuffix: true });
...
const project = ((name = 'default') => {
    ...
    const updateProjectList = () => {
        projectList = _functions_storage__WEBPACK_IMPORTED_MODULE_2__.storage.getFromLocalStorage();
    }
    ...
    const addToProjectItem = (title, details, dueDate, dueTime, priority, done = { flag: false, timestamp: null }, name = 'default') => {
        ...
        let index =  name + '~' + (0,uuid__WEBPACK_IMPORTED_MODULE_7__["default"])();
...
document.querySelector('#content').addEventListener('click', (e) => {
    ...
    if (e.target.closest('.todo-item .todo-delete')) {
        _pages_all__WEBPACK_IMPORTED_MODULE_5__.project.projectItemDeleted( e.target.closest('.todo-item').id);
